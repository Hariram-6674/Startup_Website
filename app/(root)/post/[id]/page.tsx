      ...
      <div className="space-y-5 mt-10 max-w-4xl mx-auto">
        <div className="flex-between gap-5">
          <Link className="flex gap-2 items-center mb-3" href={`/user/${post.author?._id}`}>
            <Image src={post.author?.image} alt="Profile Pic" width={64} height={64} className="rounded-full drop-shadow-lg"/>
            <div>
        ...
        {markContent ? (
          <article className="prose max-w-4xl font-workSans break-all" dangerouslySetInnerHTML={{__html: markContent}}/>
